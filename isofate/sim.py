...
ax5.annotate(f'Rp = {round(rp_a[-1]/Re, 2)} Re, Mp = {round(Mp/Me, 2)} Me, Teq = {round(T, 0)} K', (1e6, 5500), fontsize = 8)
ax5.annotate('final fatm:'+str(round(fenv_a[-1], 6)), (1e6, 5100), fontsize = 8)
ax5.annotate('final D/H:'+str(round(ND_a[-1]/NH_a[-1]/DtoH_solar, 2))+' [Solar]', (1e6, 4700), fontsize = 8)
if n_atmodeller != 0:
    ax5.annotate('final He concn:'+str(round(x_He_molecular, 4))+'='+str(round(Y[-1], 4))+' kg/kg', (1e6, 4300), fontsize = 8)
    ax5.annotate('final O2 concn:'+str(round(x_O2, 4)), (1e6, 3900), fontsize = 8)
    ax5.annotate('final H2O concn:'+str(round(x_H2O, 4)), (1e6, 3500), fontsize = 8)
    ax5.annotate('final CO2 concn:'+str(round(x_CO2, 4)), (1e6, 3100), fontsize = 8)
    ax5.annotate('final CO concn:'+str(round(x_CO, 4)), (1e6, 2700), fontsize = 8)
    ax5.annotate('final CH4 concn:'+str(round(x_CH4, 4)), (1e6, 2300), fontsize = 8)
    ax5.annotate('final H2 concn:'+str(round(x_H2, 4)), (1e6, 1900), fontsize = 8)
    ax5.annotate('final N2 concn:'+str(round(x_N2, 4)), (1e6, 1500), fontsize = 8)
    ax5.annotate('final S2 concn:'+str(round(x_S2, 4)), (1e6, 1100), fontsize = 8)
