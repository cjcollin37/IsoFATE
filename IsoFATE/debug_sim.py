...
N_H = (1 - DtoH_solar_mass - OtoH_enhanced_mass - CtoH_protosolar_mass)*M_atm/(1 + HetoH_protosolar_mass)/mu_H  # initial H number [atoms]
# N_H = 0
# N_H = M_atm/mu_H
...
Rp_override = Rp_override, t_sat = t_sat, 
...
ax2.set_ylabel(r'N$_{He}$/(N$_H$+N$_{He}$)', labelpad = 2)
# if ND_a[0] != 0:
